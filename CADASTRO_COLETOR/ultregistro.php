...
if(!empty($_POST)) {
  ...
  $_SESSION['cadastro']['endereco'] = $_POST['endereco'];
  ...
  try {
    if ($conn) {
                ...
                logradouro, cep, estado, bairro
                ) VALUES (
                  :logradouro, :cep, :estado, :bairro
                )");
                $stmt_endereco->bindParam(':logradouro', $dados['cidade']);
          ...
          <div class="form-body">
            ...
            <div class="form-row full">
              <div class="form-group">
                ...
                <input type="text" id="address" name="endereco" placeholder="Rua, número, complemento" required>
              </div>
            </div>
