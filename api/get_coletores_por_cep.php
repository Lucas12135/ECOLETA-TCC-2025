...
LEFT JOIN enderecos e 
    ON col.id_endereco = e.id
LEFT JOIN coletores_config cc 
    ON col.id = cc.id_coletor
LEFT JOIN historico_coletas hc 
    ON col.id = hc.id_coletor
WHERE 
    cc.disponibilidade = 'disponivel'
";
    ...
    $sql .= "
    GROUP BY col.id
    ORDER BY col.avaliacao_media DESC, total_coletas DESC
    LIMIT 10
    ";
