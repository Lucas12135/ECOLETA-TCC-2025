...
<head>
  <meta charset="UTF-8">
  <title>Digitar código - Gerador | Ecoleta</title>
...
<body>
  ...
  <header>
    ...
    <div class="ecoleta-title">Ecoleta • Código de verificação (Gerador)</div>
  </header>
  ...
  <main class="otp-wrapper">
    <section class="otp-card">
      ...
      <form id="otpForm" method="POST" action="../verify_otp.php">
        ...
        <!-- Mensagem de erro do código, AGORA logo abaixo do botão -->
      ...
      <p class="otp-footer-text" style="margin-top: 18px;">
        ...
        <a href="otp_request_gerador.php">Alterar e-mail</a>
      </p>
    </section>
  </main>
