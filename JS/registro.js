...
// Máscara para CPF
if(document.getElementById("cpf")) document.getElementById("cpf").addEventListener("input", function (e) {
...
// Máscara para CNPJ
if(document.getElementById("cnpj")) document.getElementById("cnpj").addEventListener("input", function (e) {
  let value = e.target.value.replace(/\D/g, "");
  value = value.replace(/^(\d{2})(\d)/, "$1.$2"); // 00.
  value = value.replace(/^(\d{2}\.\d{3})(\d)/, "$1.$2"); // 00.000.
  value = value.replace(/^(\d{2}\.\d{3}\.\d{3})(\d)/, "$1/$2"); // 00.000.000/
  value = value.replace(/^(\d{2}\.\d{3}\.\d{3}\/\d{4})(\d{1,2})/, "$1-$2"); // 00.000.000/0000-00
